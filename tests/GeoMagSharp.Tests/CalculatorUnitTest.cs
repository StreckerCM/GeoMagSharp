    ...
    public class CalculatorUnitTest
    {
        ...
        private MagneticModelSet CreateTestModelSet()
        {
            ...
            var possiblePaths = new[]
            {
                ...
                Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "..", "TestData", "WMM2015.COF"),
                Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "..", "..", "tests", "GeoMagSharp.Tests", "TestData", "WMM2015.COF"),
                @"C:\GitHub\GeoMagSharp\tests\GeoMagSharp.Tests\TestData\WMM2015.COF"
            };
